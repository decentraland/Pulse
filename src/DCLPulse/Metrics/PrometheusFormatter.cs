...
internal static class PrometheusFormatter
{
    ...
    public static void Write(StreamWriter writer, MetricsSnapshot snap)
    {
        ...
        WriteCounter(writer, "dcl_pulse_cluster_republishes_total", "Settled assignments re-emitted by the periodic sweep on peer.{wallet}.cluster_refresh. Zero means the sweep is disabled (Clusters:RepublishIntervalPasses).", snap.Clusters.TotalRepublishes);
